...
export default function Auth() {
  ...
  const handleSignIn = async (e: React.FormEvent) => {
    ...
    const email = signInUsername.includes("@") ? signInUsername : `${signInUsername}@user.local`;
  ...
  const handleSignUp = async (e: React.FormEvent) => {
    ...
    const email = signUpUsername.includes("@") ? signUpUsername : `${signUpUsername}@user.local`;
    const { error } = await signUp(email, signUpPassword, signUpName);
      ...
      <Card className="w-full max-w-md">
        ...
        <CardContent>
          <Tabs value={activeTab} onValueChange={(v) => setActiveTab(v as "signin" | "signup")}>
            ...
            <TabsContent value="signin" forceMount className={activeTab !== "signin" ? "hidden" : ""}>
